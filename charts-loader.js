...
google.charts.setOnLoadCallback(() => fetchDataAndDrawChart('https://raw.githubusercontent.com/Nikola-Radojicic/google-charts-website/main/data113_norm.csv'));
...
function updateRadarChart() {
    ...
    const datasets = countryIds.map((countryId, index) => {
        ...
        return {
            label: countryName,
            data: [
                parseFloat(document.getElementById(`${countryId}-economy`).innerText) || 0,
                parseFloat(document.getElementById(`${countryId}-innovationCooperation`).innerText) || 0,
                parseFloat(document.getElementById(`${countryId}-sustainability`).innerText) || 0,
                parseFloat(document.getElementById(`${countryId}-regulationGovernance`).innerText) || 0
            ],
            fill: true,
...
$(document).ready(function() {
    ...
    fetchDataAndDrawChart('https://raw.githubusercontent.com/Nikola-Radojicic/google-charts-website/main/data113_norm.csv'); // Call this to initialize the data and table on page load
});
